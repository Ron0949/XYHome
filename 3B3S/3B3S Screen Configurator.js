...
var _S5="";
var _S15=",";
var _S25="Select CC Number (0-127)";
var _S2="MTrk";
var _S19="Select the 'Toggle' CC number then click 'Toggle' on the target button.";
var _S3="Manson Screen Configurator";
var _S9="Octave ";
var _S12="Four_Sliders.mid";
var _S7="C C#D EbE F F#G G#A BbB ";
var _S8="Note ";
var _S29="Data\\Four Sliders.png";
var _S21="Select the Controller Number then click the target slider.";
var _S30="Data\\Screen Quadrants.png";
var _S24="Hold Switch CC Number (0-127)";
var _S13="Four_Buttons.mid";
var _S34="Data\\LED Off.png";
var _S33="Data\\Green LED.png";
var _S22="Click to select MIDI H/W, program the guitar and export a MIDI file to 'Download' folder";
var _S1="MThd";
var _S14="3B3S.mid";
var _S4="MIDI_File_Template.mid";
var _S28="Data\\Ableton.png";
...
var _S26="audio/midi";
var _S20="Select the 'Momentary' CC number then click 'Momentary' on the target button.";
var _S32="Data\\Knob turned 4.png";
var _S31="Data\\Screen 1 - Copy 4.png";
...
var v_progtext=0;
if (v_status==0) {
spider_OpenWindow(1,0,0,spider_ImageWidth(v_objectid),spider_ImageHeight(v_objectid),_S17,4608,1);
...
spider_AddGadgetItem(42,-1,_S5+spider_Str(v_index));
}
...
spider_TextGadget(44,127,520,185,30,_S24,5);
...
v_index=0;
for (;127>=v_index;v_index+=1) {
spider_AddGadgetItem(43,-1,_S5+spider_Str(v_index));
}
...
spider_TextGadget(45,87,152,160,30,_S25,5);
...
spider_ExportFile(0,_S26,65536);
spider_CloseFile(0);
...
spider_LoadImage(0,_S30);
} else if (v_config==5) {
spider_LoadImage(0,_S31);
}
spider_LoadImage(3,_S32);
spider_LoadImage(2,_S33);
spider_LoadImage(1,_S34);
return 0;
}
