...
var _S8="Note ";
var _S26="Data\\Four Sliders.png";
var _S21="Select the Controller Number then click the target slider.";
var _S27="Data\\Screen Quadrants.png";
var _S17="Select Note";
var _S13="Four_Buttons.mid";
var _S30="Data\\LED Off.png";
var _S29="Data\\Green LED.png";
var _S1="MThd";
var _S28="Data\\Knob turned 2.png";
var _S20="Select the Note and Octave then click the target button.";
var _S22="Click to program guitar and export MIDI file to your 'Download' folder";
var _S4="MIDI_File_Template.mid";
var _S19="Select Slider MIDI Controller number";
var _S25="Data\\Ableton.png";
var _S11="Multi-Function.mid";
var _S18="Select Octave";
var _S10="XY_Screen.mid";
var _S15="http:///winterwood.atwebpages.com/WebMidi?";
var _S6="MIDI Controller ";
var _S24="Data\\XY Kaoss.png";
var _S16="Manson Guitar Works - Multi-Zone Screen Configurator";
var _S23="audio/midi";
...
var v_ctrlstext=0;
var v_status=0;
var v_octavesslider=0;
var v_ctrlsslider=0;
var v_progtext=0;
if (v_status==0) {
spider_OpenWindow(1,50,50,538,598,_S16,513);
spider_ImageGadget(-1,372,466,spider_ImageWidth(v_objectid),spider_ImageHeight(v_objectid),spider_ImageID(3));
spider_ImageGadget(-1,390,200,spider_ImageWidth(v_objectid),spider_ImageHeight(v_objectid),spider_ImageID(2));
spider_ImageGadget(-1,0,0,spider_ImageWidth(v_objectid),spider_ImageHeight(v_objectid),spider_ImageID(0));
spider_ImageGadget(-1,390,200,0,0,spider_ImageID(1));
} else if (v_status==2) {
}
spider_CanvasGadget(4,106,230,30,30,16);
spider_BindGadgetEvent(4,f_buttonhandler,65540);
spider_BindGadgetEvent(4,f_help,65537);
spider_BindGadgetEvent(4,f_help,65538);
spider_CanvasGadget(3,159,230,30,30,16);
spider_BindGadgetEvent(3,f_buttonhandler,65540);
spider_BindGadgetEvent(3,f_help,65537);
spider_BindGadgetEvent(3,f_help,65538);
spider_CanvasGadget(2,215,230,30,30,16);
spider_BindGadgetEvent(2,f_buttonhandler,65540);
spider_BindGadgetEvent(2,f_help,65537);
spider_BindGadgetEvent(2,f_help,65538);
spider_CanvasGadget(1,269,230,30,30,16);
spider_BindGadgetEvent(1,f_buttonhandler,65540);
spider_BindGadgetEvent(1,f_help,65537);
spider_BindGadgetEvent(1,f_help,65538);
spider_CanvasGadget(8,106,275,30,30,16);
spider_BindGadgetEvent(8,f_buttonhandler,65540);
spider_BindGadgetEvent(8,f_help,65537);
spider_BindGadgetEvent(8,f_help,65538);
spider_CanvasGadget(7,159,275,30,30,16);
spider_BindGadgetEvent(7,f_buttonhandler,65540);
spider_BindGadgetEvent(7,f_help,65537);
spider_BindGadgetEvent(7,f_help,65538);
spider_CanvasGadget(6,215,275,30,30,16);
spider_BindGadgetEvent(6,f_buttonhandler,65540);
spider_BindGadgetEvent(6,f_help,65537);
spider_BindGadgetEvent(6,f_help,65538);
spider_CanvasGadget(5,269,275,30,30,16);
spider_BindGadgetEvent(5,f_buttonhandler,65540);
spider_BindGadgetEvent(5,f_help,65537);
spider_BindGadgetEvent(5,f_help,65538);
spider_CanvasGadget(12,106,359,30,125,16);
spider_BindGadgetEvent(12,f_buttonhandler,65540);
spider_BindGadgetEvent(12,f_help,65537);
spider_BindGadgetEvent(12,f_help,65538);
spider_CanvasGadget(11,159,359,30,125,16);
...
spider_CanvasGadget(10,215,359,30,125,16);
...
spider_CanvasGadget(25,0,310,530,50,16);
spider_BindGadgetEvent(25,f_help,65537);
spider_BindGadgetEvent(25,f_help,65538);
v_notesslider=spider_TrackBarGadget(13,v_notessliderxpos,v_slidery,90,10,0,11);
spider_BindGadgetEvent(13,f_noteshandler);
v_notetext=spider_TextGadget(14,v_notesxpos,v_textboxy,80,23,_S17,5);
spider_SetGadgetColor(14,2,6983577);
v_octavesslider=spider_TrackBarGadget(15,v_octavessliderxpos,v_slidery,98,10,0,9);
spider_BindGadgetEvent(15,f_octaveshandler);
v_octavetext=spider_TextGadget(16,v_octavesxpos,v_textboxy,90,23,_S18,5);
spider_SetGadgetColor(16,2,6983577);
v_ctrlsslider=spider_TrackBarGadget(17,(v_ctrlssliderxpos+-5),v_slidery,275,10,0,127);
spider_BindGadgetEvent(17,f_ctrlshandler);
v_ctrlstext=spider_TextGadget(18,v_ctrlsxpos,v_textboxy,265,23,_S19,5);
spider_SetGadgetColor(18,2,6983577);
v_helptext=spider_TextGadget(22,170,65,320,25,_S20,4);
spider_SetGadgetColor(22,2,6983577);
spider_HideGadget(22,1);
v_helptext=spider_TextGadget(23,170,65,320,25,_S21,4);
spider_SetGadgetColor(23,2,6983577);
spider_HideGadget(23,1);
v_helptext=spider_TextGadget(24,170,65,320,40,_S22,4);
spider_SetGadgetColor(24,2,6983577);
spider_HideGadget(24,1);
v_progtext=spider_TextGadget(30,100,224,210,272,_S5,5);
spider_SetGadgetColor(30,2,2895799);
spider_HideGadget(30,1);
f_miditemplate(v_config);
return 0;
}
function f_editmidifile(v_type,v_buttonnum,v_value) {
var v_ccnoffset=0;
var v_i=0;
...
if (v_type==1) {
v_offset=(v_ccnoffset+((v_buttonnum+-9)*5));
a_MDhd.array[v_offset]=v_value;
} else if (v_type==2) {
v_offset=(v_noteonoffset+((v_buttonnum+-1)*5));
a_MDhd.array[v_offset]=v_value;
}
v_i=1;
...
var v_ctrltext=0;
v_ctrltext=spider_TextGadget(18,v_ctrlsxpos,v_textboxy,265,23,_S6+spider_Str(spider_GetGadgetState(17)),5);
spider_SetGadgetColor(18,2,6983577);
...
var v_i=0;
var v_result=0;
spider_ImageGadget(20,372,466,spider_ImageWidth(v_objectid),spider_ImageHeight(v_objectid),spider_ImageID(3));
...
v_i=1;
for (;spider_ArraySize(a_MDhd)>=v_i;v_i+=1) {
v_url$=v_url$+spider_Str(a_MDhd.array[v_i])+_S14;
}
v_url$=_S15+v_url$;
spider_HideGadget(30,0);
spider_HideGadget(31,0);
spider_WebGadget(90,100,224,210,272,v_url$);
return 0;
}
...
function f_octaveshandler() {
var v_octavetext=0;
v_octavetext=spider_TextGadget(16,v_octavesxpos,v_textboxy,90,23,_S9+spider_Str(spider_GetGadgetState(15)),5);
spider_SetGadgetColor(16,2,6983577);
v_octnum=spider_GetGadgetState(15);
v_notenum=(spider_GetGadgetState(13)+(v_octnum*12));
return 0;
}
function f_help() {
var v_result=0;
...
spider_HideGadget(18,0);
spider_HideGadget(14,0);
spider_HideGadget(16,0);
}
return 0;
}
...
spider_ExportFile(0,_S23,65536);
spider_CloseFile(0);
...
function f_noteshandler() {
var v_notetext=0;
var v_notes$="";
var v_note$="";
v_notes$=_S7;
v_note$=spider_Mid(v_notes$,((spider_GetGadgetState(13)*2)+1),2);
v_notetext=spider_TextGadget(14,v_notesxpos,v_textboxy,80,23,_S8+spider_Mid(v_notes$,((spider_GetGadgetState(13)*2)+1),2),5);
spider_SetGadgetColor(14,2,6983577);
v_notenum=(spider_GetGadgetState(13)+(v_octnum*12));
return 0;
}
...
spider_ImageGadget(19,390,200,0,0,spider_ImageID(1));
return 0;
}
function f_buttonhandler(v_button) {
var v_result=0;
spider_ImageGadget(-1,390,200,0,0,spider_ImageID(2));
spider_AddWindowTimer(1,1,300);
spider_BindEvent(12,f_ledoff);
if (spider_EventGadget()>=9) {
v_result=f_editmidifile(1,spider_EventGadget(),v_ctrlnum);
} else {
v_result=f_editmidifile(2,spider_EventGadget(),v_notenum);
}
return 0;
}
...
spider_LoadImage(3,_S28);
spider_LoadImage(2,_S29);
spider_LoadImage(1,_S30);
return 0;
}
//
