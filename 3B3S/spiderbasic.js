...
var _S18=",";
var _S4="Template =";
var _S32="Select CC Number (0-127)";
var _S2="MTrk";
var _S26="Select the 'Toggle' CC number then click 'Toggle' on the target button.";
var _S3="Manson Screen Configurator";
var _S24="Error when loading the file: ";
var _S10="Octave ";
var _S14="Four_Sliders.mid";
var _S8="C C#D EbE F F#G G#A BbB ";
var _S9="Note ";
var _S41="Data\\Four Sliders.png";
var _S11="Knob clicked";
var _S35=": loading error";
var _S28="Select the Controller Number then click the target slider.";
var _S42="Data\\Screen Quadrants.png";
var _S31="Hold Switch CC Number (0-127)";
var _S20="https://ron0949.github.io/XYHome/Program/index.html?";
var _S15="Four_Buttons.mid";
var _S46="Data\\LED Off.png";
var _S45="Data\\Green LED.png";
var _S38="Config =";
var _S29="Click to select MIDI H/W, program the guitar and export a MIDI file to 'Download' folder";
var _S1="MThd";
var _S22="Array size load images ";
var _S17="Array size knob clicked ";
var _S16="3B3S.mid";
var _S5="MIDI_File_Template.mid";
var _S40="Data\\Ableton.png";
var _S33="Array size pre MIDI Template ";
var _S13="Multi-Function.mid";
var _S25="Select the Controller Number then click the target slider or button on the 'screen' below";
var _S7="Slider MIDI Controller Number = ";
var _S37="file exported";
var _S12="XY_Screen.mid";
var _S30="Select the CC number for the Hold switch";
var _S34="Array size post MIDI Template ";
var _S39="Data\\XY Kaoss.png";
var _S21="Array size edit MIDI file ";
var _S23="Manson Guitar Works - Multi-Zone Screen Configurator";
var _S36="audio/midi";
var _S27="Select the 'Momentary' CC number then click 'Momentary' on the target button.";
var _S44="Data\\Knob turned 4.png";
var _S43="Data\\Screen 1 - Copy 4.png";
...
function spider_ClearScreen(a){spider.screen.renderer.backgroundColor=a>>16&255|a&65280|a<<16&16711680}function spider_FlipBuffers(){function a(){var b=Date.now(),d=spider.screen.frameDurationMS|0,c=b-spider.screen.lastFrameDate;c>=d||16==d?(spider.screen.lastFrameDate=b-c%d,b=spider.screen.stage,spider.sprite.NewFrame(),spider.event.Send(17,0,0,0),spider.screen.renderer.render(b)):requestAnimationFrame(a)}requestAnimationFrame(a)}function spider_ScreenWidth(){return spider.screen.width}
function spider_ScreenHeight(){return spider.screen.height}function spider_ScreenDepth(){return spider.screen.depth}function spider_SetFrameRate(a){spider.screen.frameDurationMS=1E3/a}function spider_IsScreenActive(){return spider.screen.isActive};
...
var v_ctrlsslider=0;
var v_progtext=0;
spider.debug.Print(_S22+spider_Str(spider_ArraySize(a_MDhd)));
if (v_status==0) {
spider_OpenWindow(1,0,0,spider_ImageWidth(v_objectid),spider_ImageHeight(v_objectid),_S23,4608,1);
spider_ImageGadget(3,372,466,spider_ImageWidth(v_objectid),spider_ImageHeight(v_objectid),spider_ImageID(3));
spider_ImageGadget(2,403,160,spider_ImageWidth(v_objectid),spider_ImageHeight(v_objectid),spider_ImageID(2));
spider_ImageGadget(0,0,0,spider_ImageWidth(v_objectid),spider_ImageHeight(v_objectid),spider_ImageID(0));
spider_ImageGadget(19,403,160,0,0,spider_ImageID(1));
spider.debug.Print(spider_ImageWidth(v_objectid));
spider.debug.Print(v_objectid);
} else if (v_status==2) {
spider.debug.Print(_S24+v_filename$);
}
...
spider_CanvasGadget(28,85,520,30,30,16);
spider_BindGadgetEvent(28,f_help,65537);
spider_BindGadgetEvent(28,f_help,65538);
...
v_ctrlstext=spider_TextGadget(18,25,105,475,28,_S25,5);
spider_SetGadgetColor(18,2,spider_RGB(46,49,52));
spider_SetGadgetColor(18,1,spider_RGB(180,180,180));
v_helptext=spider_TextGadget(22,25,575,475,25,_S26,5);
spider_SetGadgetColor(22,2,spider_RGB(46,49,52));
spider_SetGadgetColor(22,1,spider_RGB(180,180,180));
spider_HideGadget(22,1);
v_helptext=spider_TextGadget(26,25,575,475,25,_S27,5);
spider_SetGadgetColor(26,2,spider_RGB(46,49,52));
spider_SetGadgetColor(26,1,spider_RGB(180,180,180));
spider_HideGadget(26,1);
v_helptext=spider_TextGadget(23,25,575,475,25,_S28,5);
spider_SetGadgetColor(23,2,spider_RGB(46,49,52));
spider_SetGadgetColor(23,1,spider_RGB(180,180,180));
spider_HideGadget(23,1);
v_helptext=spider_TextGadget(24,25,575,475,25,_S29,5);
spider_SetGadgetColor(24,2,spider_RGB(46,49,52));
spider_SetGadgetColor(24,1,spider_RGB(180,180,180));
spider_HideGadget(24,1);
v_helptext=spider_TextGadget(27,25,575,475,25,_S30,5);
spider_SetGadgetColor(27,2,spider_RGB(46,49,52));
spider_SetGadgetColor(27,1,spider_RGB(180,180,180));
spider_HideGadget(27,1);
v_progtext=spider_TextGadget(30,85,195,218,277,_S6,5);
spider_SetGadgetColor(30,2,spider_RGB(46,49,52));
spider_HideGadget(30,1);
spider_ComboBoxGadget(42,312,520,55,30,1);
v_index=0;
for (;127>=v_index;v_index+=1) {
spider_AddGadgetItem(42,-1,_S6+spider_Str(v_index));
}
spider_SetGadgetState(42,20);
...
spider_TextGadget(44,127,520,185,30,_S31,5);
spider_SetGadgetColor(44,2,spider_RGB(46,49,52));
spider_SetGadgetColor(44,1,spider_RGB(180,180,180));
spider_ComboBoxGadget(43,247,152,55,30,1);
v_index=0;
for (;127>=v_index;v_index+=1) {
spider_AddGadgetItem(43,-1,_S6+spider_Str(v_index));
}
...
spider_TextGadget(45,87,152,160,30,_S32,5);
spider_SetGadgetColor(45,2,spider_RGB(46,49,52));
spider_SetGadgetColor(45,1,spider_RGB(180,180,180));
spider.debug.Print(_S33+spider_Str(spider_ArraySize(a_MDhd)));
f_miditemplate(v_config);
spider.debug.Print(_S34+spider_Str(spider_ArraySize(a_MDhd)));
return 0;
}
...
spider.debug.Print(_S21+spider_Str(spider_ArraySize(a_MDhd)));
v_i=1;
...
spider.debug.Print(v_filename$+_S35);
return 0;
}
function f_miditemplate(v_config) {
var v_i=0;
var v_result=0;
spider.debug.Print(_S4+spider_Str(v_config));
...
v_result=spider_CreateFile(0,_S5,2);
spider_ResetList(t_MIDI);
v_i=1;
...
var v_ctrltext=0;
v_ctrltext=spider_TextGadget(18,45,v_textboxy,440,23,_S7+spider_Str(spider_GetGadgetState(17)),5);
spider_SetGadgetColor(18,2,spider_RGB(46,49,52));
spider_SetGadgetColor(18,1,spider_RGB(180,180,180));
v_ctrlnum=spider_GetGadgetState(17);
spider.debug.Print(v_ctrlnum);
return 0;
}
...
v_result=spider_CreateFile(0,_S15,2);
v_i=1;
for (;spider_ArraySize(a_MDhd)>=v_i;v_i+=1) {
spider_WriteByte(0,a_MDhd.array[v_i]);
}
} else if (v_config==5) {
v_result=spider_CreateFile(0,_S16,2);
v_i=1;
for (;spider_ArraySize(a_MDhd)>=v_i;v_i+=1) {
spider_WriteByte(0,a_MDhd.array[v_i]);
}
}
spider.debug.Print(_S17+spider_Str(spider_ArraySize(a_MDhd)));
v_url$=_S6;
v_i=1;
for (;spider_ArraySize(a_MDhd)>=v_i;v_i+=1) {
v_url$=v_url$+spider_Str(a_MDhd.array[v_i])+_S18;
}
spider.debug.Print(_S19+spider_Str(spider_Len(v_url$)));
v_url$=_S20+v_url$;
spider.debug.Print(v_url$);
...
function f_help() {
var v_result=0;
v_result=spider_ExamineMouse();
v_result=spider_MouseY();
if (spider_EventType()==65537) {
if (spider_EventGadget()<4) {
spider_HideGadget(22,0);
spider_HideGadget(26,1);
spider_HideGadget(23,1);
spider_HideGadget(24,1);
spider_HideGadget(27,1);
} else if (spider_EventGadget()<7) {
spider_HideGadget(26,0);
spider_HideGadget(22,1);
spider_HideGadget(24,1);
spider_HideGadget(23,1);
spider_HideGadget(27,1);
} else if (spider_EventGadget()==21) {
spider_HideGadget(24,0);
spider_HideGadget(22,1);
spider_HideGadget(26,1);
spider_HideGadget(23,1);
spider_HideGadget(27,1);
} else if (spider_EventGadget()==28) {
spider_HideGadget(27,0);
spider_HideGadget(22,1);
spider_HideGadget(26,1);
spider_HideGadget(23,1);
spider_HideGadget(24,1);
} else if (spider_EventGadget()>=9) {
spider_HideGadget(23,0);
spider_HideGadget(22,1);
spider_HideGadget(26,1);
spider_HideGadget(24,1);
spider_HideGadget(27,1);
}
} else if (spider_EventType()==65538) {
spider_HideGadget(23,1);
spider_HideGadget(22,1);
spider_HideGadget(26,1);
spider_HideGadget(24,1);
...
spider_ExportFile(0,_S36,65536);
spider_CloseFile(0);
...
var v_result=0;
spider.debug.Print(spider_GetGadgetState(42));
spider.debug.Print(spider_GetGadgetState(43));
...
spider.debug.Print(_S38+spider_Str(v_config));
if (v_config==1) {
spider_LoadImage(0,_S39);
} else if (v_config==2) {
spider_LoadImage(0,_S40);
} else if (v_config==3) {
spider_LoadImage(0,_S41);
} else if (v_config==4) {
spider_LoadImage(0,_S42);
} else if (v_config==5) {
spider_LoadImage(0,_S43);
}
spider_LoadImage(3,_S44);
spider_LoadImage(2,_S45);
spider_LoadImage(1,_S46);
return 0;
}
//
